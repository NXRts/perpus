...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/sneat') ?>/assets/vendor/css/theme-default.css"
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">Digital Library</span>
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li class="menu-item <?php if($url==NULL){ echo "active"; } ?>">
                    ...
                    <?php if($this->session->userdata('role')=='Admin'){ ?>
                        <li class="menu-item <?php if($url=='user'){ echo "active"; } ?>">
                            <a href="<?= base_url('admin/user') ?>" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-user"></i>
                                <div data-i18n="Analytics">User</div>
                            </a>
                        </li>
                        <li class="menu-item <?php if($url=='kategori'){ echo "active"; } ?>">
                            <a href="<?= base_url('admin/kategori') ?>" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-box"></i>
                                <div data-i18n="Analytics">Kategori Buku</div>
                            </a>
                        </li>
                        <li class="menu-item <?php if($url=='buku'){ echo "active"; } ?>">
                            <a href="<?= base_url('admin/buku') ?>" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-book"></i>
                                <div data-i18n="Analytics">Buku</div>
                            </a>
                        </li>
                        <li class="menu-item <?php if($url=='peminjaman'){ echo "active"; } ?>">
                            <a href="<?= base_url('admin/peminjaman') ?>" class="menu-link">
                    ...
                    <?php if($this->session->userdata('role')=='Peminjam'){ ?>
                        <li class="menu-item <?php if($url=='buku'){ echo "active"; } ?>">
                            <a href="<?= base_url('peminjam/buku') ?>" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-book"></i>
                                <div data-i18n="Analytics">Buku</div>
                            </a>
                        </li>
                        <li class="menu-item <?php if($url=='koleksi'){ echo "active"; } ?>">
                            <a href="<?= base_url('peminjam/koleksi') ?>" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-box"></i>
                                <div data-i18n="Analytics">koleksi</div>
                            </a>
                        </li>
                        <li class="menu-item <?php if($url=='peminjaman'){ echo "active"; } ?>">
                            <a href="<?= base_url('peminjam/peminjaman') ?>" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-pencil"></i>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="<?= base_url('assets/sneat') ?>/assets/img/avatars/1.png" alt
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="<?= base_url('assets/sneat') ?>/assets/img/avatars/1.png"
                                                            alt class="w-px-40 h-auto rounded-circle" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block"><?= $this->session->userdata('nama_lengkap') ?></span>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="<?= base_url('auth/profile/'.$this->session->userdata('user_id')) ?>">
                        ...
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                <a href="https://themeselection.com" target="_blank"
                                    class="footer-link fw-bolder">Pipapip.</a>
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
